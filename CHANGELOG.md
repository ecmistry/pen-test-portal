...
- **Methodology doc updates**: New section 7 (Reports & export formats) describing report structure and PDF/Markdown/JSON exports; section 4.9 (Nikto) updated to note non-zero exit handling and output capture; sections 8–9 (Limitations, References); footer link to galaxy-api.tech/methodology.
